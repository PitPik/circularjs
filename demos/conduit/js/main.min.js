...
define("home.component",["circular","!home.component.html","article-list.component","tag-list.component","feed-menu.component","banner.component"],({Component:e},t)=>e({selector:"home",template:t,subscribe$:{this:["*"]}},class{constructor(e,t,i){this.user={},this.isLoggedIn=!1,this.articles=[],this.pagination=[],this.tags=[],this.tag="",i(this)}})),
