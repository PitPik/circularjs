...
CircularJS is very small (~7.2KB gZip) and fast and therefore the best joice for mobile apps.
...
* Great for mobile apps as it is tiny (~7.2KB) and very fast (~8x to AngularJS)
