...
define("home.component",["circular","!home.component.html","api.service","article-list.component","tag-list.component","feed-menu.component","banner.component"],({Component:e},t,i)=>e({selector:"home",template:t,subscribe$:{this:["articles","tags","tag","pagination","user","isLoggedIn"]}},class{constructor(e,t,i,s,r){this.user={},this.isLoggedIn=!1,this.articles=[],this.pagination=[],this.tags=[],this.tag="",i(this)}})),
define("profile.component",["circular","!profile.component.html","home.component","api.service"],({Component:e},t,i,s)=>e({selector:"profile",template:t,subscribe$:{this:i.subscribe$.this.concat("profileName"),profile:["*"]}},class extends i.Klass{constructor(e,t,i,s){super(e,t,i,s,"profile"),this.profile=[],this.profileName="",i(this)}follow(e,t,i){if(!this.isLoggedIn)return window.location.href="#/sign-up";s.postFollow({author:{username:i.username,following:i.following}}).then(e=>{i.following=!i.following})}})),
define("main-app.comp",["circular","data.service","api.service","navbar.comp","home.component","new-post.component","settings.component","sign-in.component","profile.component"],({Module:e,Toolbox:{Promise:t}},i,s)=>e({selector:"[main-app]",subscribe$:{this:["*"]}},class{constructor(){this.activeLink={},this.tag="",this.articleSlug="",this.user={},this.isLoggedIn=!1,this.articles=[],this.pagination=[],this.profile=[],this.profileName="",this.tags=[],this.myArticles=[],this.myPagination=[],this.myArticle={},this.comments=[],this.article=[]}onInit(e,t,s){t.addRoute({path:"(/:appName)(/:var0)(/:var1)(/:var2)(/*)",callback:({parameters:e})=>{const r=this.activeLink.app;this.activeLink=i.getLink(e.appName)||{};const n=this.activeLink.app||"";this.getData(n,e.var0,e.var1,e.var2).then(t=>this.delegateData(t,e.appName,e.var0)).then(()=>{this.articleSlug=e.var0||"",r!==n&&this.updateView(n,s.views.outlet,t)})}},!0)}getData(e,i,r,n){const a=e.substring(0,3),l=this.user&&this.user.username?this.user:void 0;switch(this.tag="hom"===a?r:"",a){case"hom":return s.articles({limit:10,offset:i||0,tag:r,ownFeed:"my-feed"===r,user:l});case"pro":return s.profile({limit:5,offset:r||0,author:i,favorited:!!n,user:l});case"art":return s.article({article:i,user:l});case"new":return this.article[0]||!i?new t(e=>e(this.article[0]||{})):s.article({article:i,user:l});default:return new t(e=>e({}))}}delegateData(e,t,i){const s=!t||"articles"===t;if(e.user&&(this.user=e.user,this.isLoggedIn=this.user&&!!this.user.username),e.articles&&s&&(this.articles=e.articles),e.pagination&&s&&(this.pagination=e.pagination),e.tags&&(this.tags=e.tags.map(e=>({key:e}))),e.articles&&!s&&(this.myArticles=e.articles),e.pagination&&!s&&(this.myPagination=e.pagination),e.article){this.article=[e.article];const t=this.user.username===e.article.author.username;this.myArticle={title:t?e.article.title:"",description:t?e.article.description:"",body:t?e.article.body:"",tagList:t?e.article.tagList.join(", "):""}}e.comments&&(this.comments=e.comments.map(t=>(t.isUser=e.user&&e.user.username===t.author.username,t))),e.profile&&(this.profileName=e.profile.username,this.profile=[{isUser:e.user&&e.profile.username===e.user.username,...e.profile,bio:e.profile.bio||""}])}updateView(e,t,i){const s=e.substring(0,3),r=`user, tag, profileName, isLoggedIn${"hom"===s?",articles, pagination, tags":"art"===s?",article, articleSlug, comments":"new"===s?",articleSlug, myArticle as article":"pro"===s?",profile, myArticles as articles, myPagination as pagination":"sig"===s?",activeLink":""}`;t.className="hide",i.renderModule({require:e,container:t,input:r,this:this,transition:(e,i)=>{e(),i(),t.className=""}}).then(e=>{})}}));