...
define("home.component",["circular","!home.component.html","api.service","article-list.component","tag-list.component","feed-menu.component","banner.component"],({Component:e},t,i)=>e({selector:"home",template:t,subscribe$:{this:["articles","tags","tag","pagination","user","isLoggedIn"]}},class{constructor(e,t,i){this.user={},this.isLoggedIn=!1,this.articles=[],this.pagination=[],this.tags=[],this.tag="",i(this)}})),
define("profile.component",["circular","!profile.component.html","home.component","api.service"],({Component:e},t,i,s)=>e({selector:"profile",template:t,subscribe$:{this:i.subscribe$.this.concat("profileName"),profile:["*"]}},class extends i.Klass{constructor(e,t,i){super(e,t,i),this.profile=[],this.profileName="",i(this)}follow(e,t,i){if(!this.isLoggedIn)return window.location.href="#/sign-up";s.postFollow({author:{username:i.username,following:i.following}}).then(e=>{i.following=!i.following})}})),
