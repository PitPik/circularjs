...
define("api.service",["toolbox"],function(e){const t=window.Promise||e.Promise,i="https://conduit.productionready.io/api/",r=()=>localStorage.getItem("jwtToken"),s=()=>!!g.appData.user,n={"Content-Type":"application/json; charset=utf-8"},a={dataType:"json"},o=(e,t,i)=>{const s=r();return i.type=e&&e.toUpperCase()||"GET",t&&(i.headers=Object.assign({},n),s&&(i.headers.Authorization="Token "+s)),i},l=e=>(null===e.user.image&&(e.user.image=""),null===e.user.bio&&(e.user.bio=""),localStorage.setItem("jwtToken",e.user.token),g.appData.user=e.user,e.user),h=(t,i,r,s)=>e.ajax(t,o("GET",i,Object.assign({cache:r,resetCache:s},a))),c=(t,i,r)=>e.ajax(t,o(i||"POST",!0,Object.assign(r?{data:JSON.stringify(r||{})}:{},a))),u=e=>e.user||!r()?new t(t=>t(e.user&&JSON.parse(JSON.stringify(e.user)))):h(`${i}user`,!0,500).then(l).catch(()=>localStorage.removeItem("jwtToken")),p=new t(e=>e()),g={appData:{},processErrors:e=>{const t=JSON.parse(e.response);return Object.keys(t.errors).map(e=>t.errors[e].map(t=>({message:`${e} ${t}`}))[0])},getFormData:e=>{const t={};for(var i=e.length;i--;)e[i].hasAttribute("name")&&(t[e[i].name]=e[i].value.trim());return t},resetForm:e=>{for(var t=e.length;t--;)e[t].value&&(e[t].value="")},toggleForm:(e,t)=>{for(var i=e.length;i--;)t?e[i].setAttribute("disabled",!0):e[i].removeAttribute("disabled")},user:e=>u(e),default:e=>u(e).then(t=>({user:t,isRegister:e.isRegister})),articles:e=>t.all([e.author?h(`${i}articles?${e.favorited?"favorited":"author"}=${encodeURIComponent(e.author)}&limit=${e.limit}&offset=${e.offset*e.limit}`,r()):h(`${i}articles${e.ownFeed?"/feed":""}?limit=${e.limit}&offset=${e.offset*e.limit}${e.tag?"&tag="+e.tag:""}`,r()).catch(()=>window.location.href="#/login"),e.isSameApp?p:h(`${i}tags`,!1,3e4),u(e)]).then(t=>({articles:t[0].articles,tags:t[1].tags,user:g.appData.user=t[2],loggedIn:s,tag:e.tag,ownFeed:e.ownFeed,pagination:((e,t)=>Array.apply(null,{length:Math.ceil((t<e.limit+1?0:t)/e.limit)}).map((t,i)=>({value:i+1+"",active:void 0!==e.offset&&e.offset==i,tag:e.tag,ownFeed:e.ownFeed,author:e.author,favorited:e.favorited||""})))(e,t[0].articlesCount)})),article:e=>t.all([h(`${i}articles/${e.article}`,r()),h(`${i}articles/${e.article}/comments`),u(e)]).then(e=>({article:e[0].article,comments:e[1].comments,user:g.appData.user=e[2],loggedIn:s})),editor:e=>t.all([e.article?h(`${i}articles/${e.article}`,r()):p]).then(e=>({article:e[0]})),profile:e=>t.all([e.isSameAuthor?p:h(`${i}profiles/${e.author}`,r()),u(e)]).then(t=>({profile:t[0],user:g.appData.user=t[1],loggedIn:s,tag:e.tag,favorited:e.favorited})),"sign-in":e=>c(`${i}users/login`,null,e).then(l).then(e=>g.appData.user=e),userLogout:e=>new t(e=>{localStorage.removeItem("jwtToken"),g.appData.user=void 0,e()}),"sign-up":e=>c(`${i}users`,null,e).then(l).then(e=>g.appData.user=e),putSettings:e=>c(`${i}user`,"PUT",e.user),postArticle:e=>e.slug?c(`${i}articles/${e.slug}`,"PUT",e):c(`${i}articles`,"POST",e),deleteArticle:e=>c(`${i}articles/${e.slug}`,"DELETE"),postComment:e=>c(`${i}articles/${e.slug}/comments`,"POST",e.comment),deleteComment:e=>c(`${i}articles/${e.slug}/comments/${e.id}`,"DELETE"),postLike:e=>c(`${i}articles/${e.slug}/favorite`,e.favorited?"DELETE":"POST"),postFollow:e=>c(`${i}profiles/${e.author.username}/follow`,e.author.following?"DELETE":"POST")};return g}),
function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define("marked",[],t):(e=e||self).marked=t()}(this,function(){"use strict";function e(e,t){for(var i=0;i<t.length;i++){var r=t[i];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function t(t,i,r){return i&&e(t.prototype,i),r&&e(t,r),t}var i,r=(function(e){function t(){return{baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,xhtml:!1}}e.exports={defaults:{baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,xhtml:!1},getDefaults:t,changeDefaults:function(t){e.exports.defaults=t}}}(i={exports:{}},i.exports),i.exports),s=(r.defaults,r.getDefaults,r.changeDefaults,/[&<>"']/),n=/[&<>"']/g,a=/[<>"']|&(?!#?\w+;)/,o=/[<>"']|&(?!#?\w+;)/g,l={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},h=function(e){return l[e]};var c=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function u(e){return e.replace(c,function(e,t){return"colon"===(t=t.toLowerCase())?":":"#"===t.charAt(0)?"x"===t.charAt(1)?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""})}var p=/(^|[^\[])\^/g;var g=/[^\w:]/g,m=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;var f={},d=/^[^:]+:\/*[^/]*$/,b=/^([^:]+:)[\s\S]*$/,k=/^([^:]+:\/*[^/]*)[\s\S]*$/;function v(e,t){f[" "+e]||(d.test(e)?f[" "+e]=e+"/":f[" "+e]=x(e,"/",!0));var i=-1===(e=f[" "+e]).indexOf(":");return"//"===t.substring(0,2)?i?t:e.replace(b,"$1")+t:"/"===t.charAt(0)?i?t:e.replace(k,"$1")+t:e+t}function x(e,t,i){var r=e.length;if(0===r)return"";for(var s=0;s<r;){var n=e.charAt(r-s-1);if(n!==t||i){if(n===t||!i)break;s++}else s++}return e.substr(0,r-s)}var w=function(e,t){if(t){if(s.test(e))return e.replace(n,h)}else if(a.test(e))return e.replace(o,h);return e},$=u,y=function(e,t,i){if(e){var r;try{r=decodeURIComponent(u(i)).replace(g,"").toLowerCase()}catch(e){return null}if(0===r.indexOf("javascript:")||0===r.indexOf("vbscript:")||0===r.indexOf("data:"))return null}t&&!m.test(i)&&(i=v(t,i));try{i=encodeURI(i).replace(/%25/g,"%")}catch(e){return null}return i},_=function(e){for(var t,i,r=1;r<arguments.length;r++)for(i in t=arguments[r])Object.prototype.hasOwnProperty.call(t,i)&&(e[i]=t[i]);return e},S=function(e,t){var i=e.replace(/\|/g,function(e,t,i){for(var r=!1,s=t;--s>=0&&"\\"===i[s];)r=!r;return r?"|":" |"}).split(/ \|/),r=0;if(i.length>t)i.splice(t);else for(;i.length<t;)i.push("");for(;r<i.length;r++)i[r]=i[r].trim().replace(/\\\|/g,"|");return i},A=x,L=function(e,t){if(-1===e.indexOf(t[1]))return-1;for(var i=e.length,r=0,s=0;s<i;s++)if("\\"===e[s])s++;else if(e[s]===t[0])r++;else if(e[s]===t[1]&&--r<0)return s;return-1},P=function(e){e&&e.sanitize&&!e.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")},D={exec:function(){}},z=function(e,t){e=e.source||e,t=t||"";var i={replace:function(t,r){return r=(r=r.source||r).replace(p,"$1"),e=e.replace(t,r),i},getRegex:function(){return new RegExp(e,t)}};return i},C=_,I={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:/^ {0,3}(`{3,}|~{3,})([^`~\n]*)\n(?:|([\s\S]*?)\n)(?: {0,3}\1[~`]* *(?:\n+|$)|$)/,hr:/^ {0,3}((?:- *){3,}|(?:_ *){3,}|(?:\* *){3,})(?:\n+|$)/,heading:/^ {0,3}(#{1,6}) +([^\n]*?)(?: +#+)? *(?:\n+|$)/,blockquote:/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/,list:/^( {0,3})(bull) [\s\S]+?(?:hr|def|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:"^ {0,3}(?:<(script|pre|style)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?\\?>\\n*|<![A-Z][\\s\\S]*?>\\n*|<!\\[CDATA\\[[\\s\\S]*?\\]\\]>\\n*|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:\\n{2,}|$)|<(?!script|pre|style)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:\\n{2,}|$)|</(?!script|pre|style)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:\\n{2,}|$))",def:/^ {0,3}\[(label)\]: *\n? *<?([^\s>]+)>?(?:(?: +\n? *| *\n*)(title))? *(?:\n+|$)/,nptable:D,table:D,lheading:/^([^\n]+)\n{0,3}(=+|-+) *(?:\n+|$)/,_paragraph:/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html)[^\n]+)*)/,text:/^[^\n]+/,_label:/(?!\s*\])(?:\\[\[\]]|[^\[\]])+/,_title:/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/};I.def=z(I.def).replace("label",I._label).replace("title",I._title).getRegex(),I.bullet=/(?:[*+-]|\d{1,9}\.)/,I.item=/^( *)(bull) ?[^\n]*(?:\n(?!\1bull ?)[^\n]*)*/,I.item=z(I.item,"gm").replace(/bull/g,I.bullet).getRegex(),I.list=z(I.list).replace(/bull/g,I.bullet).replace("hr","\\n+(?=\\1?(?:(?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$))").replace("def","\\n+(?="+I.def.source+")").getRegex(),I._tag="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",I._comment=/<!--(?!-?>)[\s\S]*?-->/,I.html=z(I.html,"i").replace("comment",I._comment).replace("tag",I._tag).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),I.paragraph=z(I._paragraph).replace("hr",I.hr).replace("heading"," {0,3}#{1,6} +").replace("|lheading","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}|~{3,})[^`\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|!--)").replace("tag",I._tag).getRegex(),I.blockquote=z(I.blockquote).replace("paragraph",I.paragraph).getRegex(),I.normal=C({},I),I.gfm=C({},I.normal,{nptable:/^ *([^|\n].*\|.*)\n*([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n].*(?:\n|$))*)\n*|$)/,table:/^ *\|(.+)\n*\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n].*(?:\n|$))*)\n*|$)/}),I.pedantic=C({},I.normal,{html:z("^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:\"[^\"]*\"|'[^']*'|\\s[^'\"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))").replace("comment",I._comment).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *(?:#+ *)?(?:\n+|$)/,fences:D,paragraph:z(I.normal._paragraph).replace("hr",I.hr).replace("heading"," *#{1,6} *[^\n]").replace("lheading",I.lheading).replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").getRegex()});var q={escape:/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,autolink:/^<(scheme:[^\s\x00-\x1f<>]*|email)>/,url:D,tag:"^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>",link:/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/,reflink:/^!?\[(label)\]\[(?!\s*\])((?:\\[\[\]]?|[^\[\]\\])+)\]/,nolink:/^!?\[(?!\s*\])((?:\[[^\[\]]*\]|\\[\[\]]|[^\[\]])*)\](?:\[\])?/,strong:/^__([^\s_])__(?!_)|^\*\*([^\s*])\*\*(?!\*)|^__([^\s][\s\S]*?[^\s])__(?!_)|^\*\*([^\s][\s\S]*?[^\s])\*\*(?!\*)/,em:/^_([^\s_])_(?!_)|^\*([^\s*<\[])\*(?!\*)|^_([^\s<][\s\S]*?[^\s_])_(?!_|[^\spunctuation])|^_([^\s_<][\s\S]*?[^\s])_(?!_|[^\spunctuation])|^\*([^\s<"][\s\S]*?[^\s\*])\*(?!\*|[^\spunctuation])|^\*([^\s*"<\[][\s\S]*?[^\s])\*(?!\*)/,code:/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,br:/^( {2,}|\\)\n(?!\s*$)/,del:D,text:/^(`+|[^`])(?:[\s\S]*?(?:(?=[\\<!\[`*]|\b_|$)|[^ ](?= {2,}\n))|(?= {2,}\n))/,_punctuation:"!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~"};q.em=z(q.em).replace(/punctuation/g,q._punctuation).getRegex(),q._escapes=/\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g,q._scheme=/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,q._email=/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,q.autolink=z(q.autolink).replace("scheme",q._scheme).replace("email",q._email).getRegex(),q._attribute=/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,q.tag=z(q.tag).replace("comment",I._comment).replace("attribute",q._attribute).getRegex(),q._label=/(?:\[[^\[\]]*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,q._href=/<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*/,q._title=/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,q.link=z(q.link).replace("label",q._label).replace("href",q._href).replace("title",q._title).getRegex(),q.reflink=z(q.reflink).replace("label",q._label).getRegex(),q.normal=C({},q),q.pedantic=C({},q.normal,{strong:/^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/,em:/^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/,link:z(/^!?\[(label)\]\((.*?)\)/).replace("label",q._label).getRegex(),reflink:z(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",q._label).getRegex()}),q.gfm=C({},q.normal,{escape:z(q.escape).replace("])","~|])").getRegex(),_extended_email:/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/,url:/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,_backpedal:/(?:[^?!.,:;*_~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_~)]+(?!$))+/,del:/^~+(?=\S)([\s\S]*?\S)~+/,text:/^(`+|[^`])(?:[\s\S]*?(?:(?=[\\<!\[`*~]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@))|(?= {2,}\n|[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@))/}),q.gfm.url=z(q.gfm.url,"i").replace("email",q.gfm._extended_email).getRegex(),q.breaks=C({},q.gfm,{br:z(q.br).replace("{2,}","*").getRegex(),text:z(q.gfm.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()});var E={block:I,inline:q},R=r.defaults,F=E.block,O=A,T=S,N=w,U=function(){function e(e){this.tokens=[],this.tokens.links=Object.create(null),this.options=e||R,this.rules=F.normal,this.options.pedantic?this.rules=F.pedantic:this.options.gfm&&(this.rules=F.gfm)}e.lex=function(t,i){return new e(i).lex(t)};var i=e.prototype;return i.lex=function(e){return e=e.replace(/\r\n|\r/g,"\n").replace(/\t/g,"    "),this.token(e,!0)},i.token=function(e,t){var i,r,s,n,a,o,l,h,c,u,p,g,m,f,d,b;for(e=e.replace(/^ +$/gm,"");e;)if((s=this.rules.newline.exec(e))&&(e=e.substring(s[0].length),s[0].length>1&&this.tokens.push({type:"space"})),s=this.rules.code.exec(e)){var k=this.tokens[this.tokens.length-1];e=e.substring(s[0].length),k&&"paragraph"===k.type?k.text+="\n"+s[0].trimRight():(s=s[0].replace(/^ {4}/gm,""),this.tokens.push({type:"code",codeBlockStyle:"indented",text:this.options.pedantic?s:O(s,"\n")}))}else if(s=this.rules.fences.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"code",lang:s[2]?s[2].trim():s[2],text:s[3]||""});else if(s=this.rules.heading.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"heading",depth:s[1].length,text:s[2]});else if((s=this.rules.nptable.exec(e))&&(o={type:"table",header:T(s[1].replace(/^ *| *\| *$/g,"")),align:s[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:s[3]?s[3].replace(/\n$/,"").split("\n"):[]}).header.length===o.align.length){for(e=e.substring(s[0].length),p=0;p<o.align.length;p++)/^ *-+: *$/.test(o.align[p])?o.align[p]="right":/^ *:-+: *$/.test(o.align[p])?o.align[p]="center":/^ *:-+ *$/.test(o.align[p])?o.align[p]="left":o.align[p]=null;for(p=0;p<o.cells.length;p++)o.cells[p]=T(o.cells[p],o.header.length);this.tokens.push(o)}else if(s=this.rules.hr.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"hr"});else if(s=this.rules.blockquote.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"blockquote_start"}),s=s[0].replace(/^ *> ?/gm,""),this.token(s,t),this.tokens.push({type:"blockquote_end"});else if(s=this.rules.list.exec(e)){for(e=e.substring(s[0].length),l={type:"list_start",ordered:f=(n=s[2]).length>1,start:f?+n:"",loose:!1},this.tokens.push(l),h=[],i=!1,m=(s=s[0].match(this.rules.item)).length,p=0;p<m;p++)u=(o=s[p]).length,~(o=o.replace(/^ *([*+-]|\d+\.) */,"")).indexOf("\n")&&(u-=o.length,o=this.options.pedantic?o.replace(/^ {1,4}/gm,""):o.replace(new RegExp("^ {1,"+u+"}","gm"),"")),p!==m-1&&(a=F.bullet.exec(s[p+1])[0],(n.length>1?1===a.length:a.length>1||this.options.smartLists&&a!==n)&&(e=s.slice(p+1).join("\n")+e,p=m-1)),r=i||/\n\n(?!\s*$)/.test(o),p!==m-1&&(i="\n"===o.charAt(o.length-1),r||(r=i)),r&&(l.loose=!0),b=void 0,(d=/^\[[ xX]\] /.test(o))&&(b=" "!==o[1],o=o.replace(/^\[[ xX]\] +/,"")),c={type:"list_item_start",task:d,checked:b,loose:r},h.push(c),this.tokens.push(c),this.token(o,!1),this.tokens.push({type:"list_item_end"});if(l.loose)for(m=h.length,p=0;p<m;p++)h[p].loose=!0;this.tokens.push({type:"list_end"})}else if(s=this.rules.html.exec(e))e=e.substring(s[0].length),this.tokens.push({type:this.options.sanitize?"paragraph":"html",pre:!this.options.sanitizer&&("pre"===s[1]||"script"===s[1]||"style"===s[1]),text:this.options.sanitize?this.options.sanitizer?this.options.sanitizer(s[0]):N(s[0]):s[0]});else if(t&&(s=this.rules.def.exec(e)))e=e.substring(s[0].length),s[3]&&(s[3]=s[3].substring(1,s[3].length-1)),g=s[1].toLowerCase().replace(/\s+/g," "),this.tokens.links[g]||(this.tokens.links[g]={href:s[2],title:s[3]});else if((s=this.rules.table.exec(e))&&(o={type:"table",header:T(s[1].replace(/^ *| *\| *$/g,"")),align:s[2].replace(/^ *|\| *$/g,"").split(/ *\| */),cells:s[3]?s[3].replace(/\n$/,"").split("\n"):[]}).header.length===o.align.length){for(e=e.substring(s[0].length),p=0;p<o.align.length;p++)/^ *-+: *$/.test(o.align[p])?o.align[p]="right":/^ *:-+: *$/.test(o.align[p])?o.align[p]="center":/^ *:-+ *$/.test(o.align[p])?o.align[p]="left":o.align[p]=null;for(p=0;p<o.cells.length;p++)o.cells[p]=T(o.cells[p].replace(/^ *\| *| *\| *$/g,""),o.header.length);this.tokens.push(o)}else if(s=this.rules.lheading.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"heading",depth:"="===s[2].charAt(0)?1:2,text:s[1]});else if(t&&(s=this.rules.paragraph.exec(e)))e=e.substring(s[0].length),this.tokens.push({type:"paragraph",text:"\n"===s[1].charAt(s[1].length-1)?s[1].slice(0,-1):s[1]});else if(s=this.rules.text.exec(e))e=e.substring(s[0].length),this.tokens.push({type:"text",text:s[0]});else if(e)throw new Error("Infinite loop on byte: "+e.charCodeAt(0));return this.tokens},t(e,null,[{key:"rules",get:function(){return F}}]),e}(),Z=r.defaults,j=y,B=w,M=function(){function e(e){this.options=e||Z}var t=e.prototype;return t.code=function(e,t,i){var r=(t||"").match(/\S*/)[0];if(this.options.highlight){var s=this.options.highlight(e,r);null!=s&&s!==e&&(i=!0,e=s)}return r?'<pre><code class="'+this.options.langPrefix+B(r,!0)+'">'+(i?e:B(e,!0))+"</code></pre>\n":"<pre><code>"+(i?e:B(e,!0))+"</code></pre>"},t.blockquote=function(e){return"<blockquote>\n"+e+"</blockquote>\n"},t.html=function(e){return e},t.heading=function(e,t,i,r){return this.options.headerIds?"<h"+t+' id="'+this.options.headerPrefix+r.slug(i)+'">'+e+"</h"+t+">\n":"<h"+t+">"+e+"</h"+t+">\n"},t.hr=function(){return this.options.xhtml?"<hr/>\n":"<hr>\n"},t.list=function(e,t,i){var r=t?"ol":"ul";return"<"+r+(t&&1!==i?' start="'+i+'"':"")+">\n"+e+"</"+r+">\n"},t.listitem=function(e){return"<li>"+e+"</li>\n"},t.checkbox=function(e){return"<input "+(e?'checked="" ':"")+'disabled="" type="checkbox"'+(this.options.xhtml?" /":"")+"> "},t.paragraph=function(e){return"<p>"+e+"</p>\n"},t.table=function(e,t){return t&&(t="<tbody>"+t+"</tbody>"),"<table>\n<thead>\n"+e+"</thead>\n"+t+"</table>\n"},t.tablerow=function(e){return"<tr>\n"+e+"</tr>\n"},t.tablecell=function(e,t){var i=t.header?"th":"td";return(t.align?"<"+i+' align="'+t.align+'">':"<"+i+">")+e+"</"+i+">\n"},t.strong=function(e){return"<strong>"+e+"</strong>"},t.em=function(e){return"<em>"+e+"</em>"},t.codespan=function(e){return"<code>"+e+"</code>"},t.br=function(){return this.options.xhtml?"<br/>":"<br>"},t.del=function(e){return"<del>"+e+"</del>"},t.link=function(e,t,i){if(null===(e=j(this.options.sanitize,this.options.baseUrl,e)))return i;var r='<a href="'+B(e)+'"';return t&&(r+=' title="'+t+'"'),r+=">"+i+"</a>"},t.image=function(e,t,i){if(null===(e=j(this.options.sanitize,this.options.baseUrl,e)))return i;var r='<img src="'+e+'" alt="'+i+'"';return t&&(r+=' title="'+t+'"'),r+=this.options.xhtml?"/>":">"},t.text=function(e){return e},e}(),G=function(){function e(){this.seen={}}return e.prototype.slug=function(e){var t=e.toLowerCase().trim().replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-");if(this.seen.hasOwnProperty(t)){var i=t;do{this.seen[i]++,t=i+"-"+this.seen[i]}while(this.seen.hasOwnProperty(t))}return this.seen[t]=0,t},e}(),J=r.defaults,X=E.inline,H=L,K=w,V=function(){function e(e,t){if(this.options=t||J,this.links=e,this.rules=X.normal,this.options.renderer=this.options.renderer||new M,this.renderer=this.options.renderer,this.renderer.options=this.options,!this.links)throw new Error("Tokens array requires a `links` property.");this.options.pedantic?this.rules=X.pedantic:this.options.gfm&&(this.options.breaks?this.rules=X.breaks:this.rules=X.gfm)}e.output=function(t,i,r){return new e(i,r).output(t)};var i=e.prototype;return i.output=function(t){for(var i,r,s,n,a,o,l="";t;)if(a=this.rules.escape.exec(t))t=t.substring(a[0].length),l+=K(a[1]);else if(a=this.rules.tag.exec(t))!this.inLink&&/^<a /i.test(a[0])?this.inLink=!0:this.inLink&&/^<\/a>/i.test(a[0])&&(this.inLink=!1),!this.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(a[0])?this.inRawBlock=!0:this.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(a[0])&&(this.inRawBlock=!1),t=t.substring(a[0].length),l+=this.options.sanitize?this.options.sanitizer?this.options.sanitizer(a[0]):K(a[0]):a[0];else if(a=this.rules.link.exec(t)){var h=H(a[2],"()");if(h>-1){var c=(0===a[0].indexOf("!")?5:4)+a[1].length+h;a[2]=a[2].substring(0,h),a[0]=a[0].substring(0,c).trim(),a[3]=""}t=t.substring(a[0].length),this.inLink=!0,s=a[2],this.options.pedantic?(i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(s))?(s=i[1],n=i[3]):n="":n=a[3]?a[3].slice(1,-1):"",s=s.trim().replace(/^<([\s\S]*)>$/,"$1"),l+=this.outputLink(a,{href:e.escapes(s),title:e.escapes(n)}),this.inLink=!1}else if((a=this.rules.reflink.exec(t))||(a=this.rules.nolink.exec(t))){if(t=t.substring(a[0].length),i=(a[2]||a[1]).replace(/\s+/g," "),!(i=this.links[i.toLowerCase()])||!i.href){l+=a[0].charAt(0),t=a[0].substring(1)+t;continue}this.inLink=!0,l+=this.outputLink(a,i),this.inLink=!1}else if(a=this.rules.strong.exec(t))t=t.substring(a[0].length),l+=this.renderer.strong(this.output(a[4]||a[3]||a[2]||a[1]));else if(a=this.rules.em.exec(t))t=t.substring(a[0].length),l+=this.renderer.em(this.output(a[6]||a[5]||a[4]||a[3]||a[2]||a[1]));else if(a=this.rules.code.exec(t))t=t.substring(a[0].length),l+=this.renderer.codespan(K(a[2].trim(),!0));else if(a=this.rules.br.exec(t))t=t.substring(a[0].length),l+=this.renderer.br();else if(a=this.rules.del.exec(t))t=t.substring(a[0].length),l+=this.renderer.del(this.output(a[1]));else if(a=this.rules.autolink.exec(t))t=t.substring(a[0].length),s="@"===a[2]?"mailto:"+(r=K(this.mangle(a[1]))):r=K(a[1]),l+=this.renderer.link(s,null,r);else if(this.inLink||!(a=this.rules.url.exec(t))){if(a=this.rules.text.exec(t))t=t.substring(a[0].length),this.inRawBlock?l+=this.renderer.text(this.options.sanitize?this.options.sanitizer?this.options.sanitizer(a[0]):K(a[0]):a[0]):l+=this.renderer.text(K(this.smartypants(a[0])));else if(t)throw new Error("Infinite loop on byte: "+t.charCodeAt(0))}else{if("@"===a[2])s="mailto:"+(r=K(a[0]));else{do{o=a[0],a[0]=this.rules._backpedal.exec(a[0])[0]}while(o!==a[0]);r=K(a[0]),s="www."===a[1]?"http://"+r:r}t=t.substring(a[0].length),l+=this.renderer.link(s,null,r)}return l},e.escapes=function(t){return t?t.replace(e.rules._escapes,"$1"):t},i.outputLink=function(e,t){var i=t.href,r=t.title?K(t.title):null;return"!"!==e[0].charAt(0)?this.renderer.link(i,r,this.output(e[1])):this.renderer.image(i,r,K(e[1]))},i.smartypants=function(e){return this.options.smartypants?e.replace(/---/g,"—").replace(/--/g,"–").replace(/(^|[-\u2014/(\[{"\s])'/g,"$1‘").replace(/'/g,"’").replace(/(^|[-\u2014/(\[{\u2018\s])"/g,"$1“").replace(/"/g,"”").replace(/\.{3}/g,"…"):e},i.mangle=function(e){if(!this.options.mangle)return e;for(var t,i=e.length,r="",s=0;s<i;s++)t=e.charCodeAt(s),Math.random()>.5&&(t="x"+t.toString(16)),r+="&#"+t+";";return r},t(e,null,[{key:"rules",get:function(){return X}}]),e}(),Y=function(){function e(){}var t=e.prototype;return t.strong=function(e){return e},t.em=function(e){return e},t.codespan=function(e){return e},t.del=function(e){return e},t.text=function(e){return e},t.link=function(e,t,i){return""+i},t.image=function(e,t,i){return""+i},t.br=function(){return""},e}(),Q=r.defaults,W=_,ee=$,te=function(){function e(e){this.tokens=[],this.token=null,this.options=e||Q,this.options.renderer=this.options.renderer||new M,this.renderer=this.options.renderer,this.renderer.options=this.options,this.slugger=new G}e.parse=function(t,i){return new e(i).parse(t)};var t=e.prototype;return t.parse=function(e){this.inline=new V(e.links,this.options),this.inlineText=new V(e.links,W({},this.options,{renderer:new Y})),this.tokens=e.reverse();for(var t="";this.next();)t+=this.tok();return t},t.next=function(){return this.token=this.tokens.pop(),this.token},t.peek=function(){return this.tokens[this.tokens.length-1]||0},t.parseText=function(){for(var e=this.token.text;"text"===this.peek().type;)e+="\n"+this.next().text;return this.inline.output(e)},t.tok=function(){var e="";switch(this.token.type){case"space":return"";case"hr":return this.renderer.hr();case"heading":return this.renderer.heading(this.inline.output(this.token.text),this.token.depth,ee(this.inlineText.output(this.token.text)),this.slugger);case"code":return this.renderer.code(this.token.text,this.token.lang,this.token.escaped);case"table":var t,i,r,s,n="";for(r="",t=0;t<this.token.header.length;t++)r+=this.renderer.tablecell(this.inline.output(this.token.header[t]),{header:!0,align:this.token.align[t]});for(n+=this.renderer.tablerow(r),t=0;t<this.token.cells.length;t++){for(i=this.token.cells[t],r="",s=0;s<i.length;s++)r+=this.renderer.tablecell(this.inline.output(i[s]),{header:!1,align:this.token.align[s]});e+=this.renderer.tablerow(r)}return this.renderer.table(n,e);case"blockquote_start":for(e="";"blockquote_end"!==this.next().type;)e+=this.tok();return this.renderer.blockquote(e);case"list_start":e="";for(var a=this.token.ordered,o=this.token.start;"list_end"!==this.next().type;)e+=this.tok();return this.renderer.list(e,a,o);case"list_item_start":e="";var l=this.token.loose,h=this.token.checked,c=this.token.task;if(this.token.task)if(l)if("text"===this.peek().type){var u=this.peek();u.text=this.renderer.checkbox(h)+" "+u.text}else this.tokens.push({type:"text",text:this.renderer.checkbox(h)});else e+=this.renderer.checkbox(h);for(;"list_item_end"!==this.next().type;)e+=l||"text"!==this.token.type?this.tok():this.parseText();return this.renderer.listitem(e,c,h);case"html":return this.renderer.html(this.token.text);case"paragraph":return this.renderer.paragraph(this.inline.output(this.token.text));case"text":return this.renderer.paragraph(this.parseText());default:var p='Token with "'+this.token.type+'" type was not found.';if(!this.options.silent)throw new Error(p);console.log(p)}},e}(),ie=_,re=P,se=w,ne=r.getDefaults,ae=r.changeDefaults,oe=r.defaults;function le(e,t,i){if(void 0===e||null===e)throw new Error("marked(): input parameter is undefined or null");if("string"!=typeof e)throw new Error("marked(): input parameter is of type "+Object.prototype.toString.call(e)+", string expected");if(i||"function"==typeof t){var r=function(){i||(i=t,t=null),t=ie({},le.defaults,t||{}),re(t);var r,s,n=t.highlight,a=0;try{r=U.lex(e,t)}catch(e){return{v:i(e)}}s=r.length;var o=function(e){if(e)return t.highlight=n,i(e);var s;try{s=te.parse(r,t)}catch(t){e=t}return t.highlight=n,e?i(e):i(null,s)};if(!n||n.length<3)return{v:o()};if(delete t.highlight,!s)return{v:o()};for(;a<r.length;a++)!function(e){"code"!==e.type?--s||o():n(e.text,e.lang,function(t,i){return t?o(t):null==i||i===e.text?--s||o():(e.text=i,e.escaped=!0,void(--s||o()))})}(r[a]);return{v:void 0}}();if("object"==typeof r)return r.v}try{return t=ie({},le.defaults,t||{}),re(t),te.parse(U.lex(e,t),t)}catch(e){if(e.message+="\nPlease report this to https://github.com/markedjs/marked.",(t||le.defaults).silent)return"<p>An error occurred:</p><pre>"+se(e.message+"",!0)+"</pre>";throw e}}return le.options=le.setOptions=function(e){return ie(le.defaults,e),ae(le.defaults),le},le.getDefaults=ne,le.defaults=oe,le.Parser=te,le.parser=te.parse,le.Renderer=M,le.TextRenderer=Y,le.Lexer=U,le.lexer=U.lex,le.InlineLexer=V,le.inlineLexer=V.output,le.Slugger=G,le.parse=le,le}),
...
define("feed-menu.component",["circular","!feed-menu.component.html"],({Component:e},t)=>e({selector:"feed-menu",template:t,subscribe$:{model:["*"],this:["activeFeed","tag","isLoggedIn","profileName","routeParams"]},styles:"feed-menu { display: block }"},class{constructor(e,t,i){this.tag="",this.isLoggedIn=!1,this.profileName="",this.routeParams={},i(this),this.model=[],this.activeFeed={},this.setLinks(),this.activeFeed.active=!0}setLinks(){const e=void 0!==this.routeParams.appName,t=!!this.profileName,i=t?"My Articles":"Your Feed",r=t?"Favorited Articles":"Global Feed",s="my-feed"===this.tag,n=`profile/${this.profileName}/0`,a=t?n:"articles/0/",o=t?"":"my-feed",l=[{link:t?a+"/favorites":"",title:r,active:!1}];(this.isLoggedIn||t)&&l.unshift({link:a+o,title:i,active:!1}),this.tag&&!s&&l.push({link:a+this.tag,title:"#"+this.tag,active:!0}),e||(this.activeFeed=this.tag&&!s?l[l.length-1]:s||!this.isLoggedIn&&!this.routeParams.var2?l[0]:l[1]),this.model=l,e&&(this.activeFeed=this.model[this.routeParams.var2?1:0])}this$(e,t,i,r){"activeFeed"===e&&(r&&(r.active=!1),i&&(i.active=!0)),i!==r&&(("tag"===e||"isLoggedIn"===e&&!this.profileName)&&this.setLinks(),"profileName"===e&&this.setLinks(),"routeParams"===e&&"profile"===i.appName&&(this.activeFeed=this.model[i.var2?1:0]))}toggle(e,t,i){this.activeFeed=i}})),
...
define("template-helpers",["marked"],function(e){const t={short:{},numeric:{}};return{itsme:function(e,t){return e===t?this.getBody():this.gatAltBody()},"my-comment":function(e,t){return e===t?this.getBody():""},"simple-date":function(e,i){const r=e,s={year:"numeric",month:"long",day:"short"===i?void 0:"numeric"},n=s.day||"short",a=r.substr(0,10);return t[n][a]=t[n][a]||new Date(r).toLocaleDateString(void 0,s),t[n][a]},markdown:function(t){return e(t.trim())}}}),
define("navbar.comp",["circular","!navbar.comp.html","data.service"],({Component:e},t,i)=>e({selector:"navbar",template:t,styles:"navbar .hidden { display: none; }",subscribe$:{navigation:["active","visible","title","link","image"],this:["activeLink","user"]}},class{constructor(e,t,r){this.activeLink={},this.user={},r(this),this.navigation=i.getLinks()}this$(e,t,i,r={}){"user"===e&&((i=i||{}).id===r.id&&i||this.navigation.forEach(e=>{if(!1!==e.image&&(e.image=this.user?this.user.image:""),-1!==e.link.indexOf("profile")&&(e.link="profile/"+i.username,e.title=i.username),void 0!==e.manage){var t=e.manage?!!i.username:!i.username;e.visible=t}else e.visible=!0})),"activeLink"===e&&(r.active=!1,i.active=!0)}})),
define("settings.component",["circular","!settings.component.html","api.service"],({Component:e},t,i)=>e({selector:"settings",template:t,subscribe$:{this:["errors"],model:["*"]}},class{constructor(e,t,r,s){this.user={},this.setUser=(()=>{}),r(this),this.model=[],this.errors=[],i.user({user:this.user.username?this.user:void 0}).then(e=>{this.setUser(e),this.model=[{errors:[],...e}]})}logout(){i.userLogout().then(()=>{this.setUser(void 0),window.location.href="#/"})}submit(e,t,r){e.preventDefault();const s={...i.getFormData(t),id:this.user.id};s.password||delete s.password,i.toggleForm(t,!0),i.putSettings({user:{...i.getFormData(t),id:this.user.id}}).then(e=>i.toggleForm(t,!1)).catch(e=>{this.errors=i.processErrors(e)})}})),
define("sign-in.component",["circular","!sign-in.component.html","api.service"],({Component:e},t,i)=>e({selector:"sign-in",template:t,subscribe$:{this:["routeParams","isSignIn","errors","formDisabled"]}},class{constructor(e,t,i){this.routeParams={},i(this),this.errors=[],this.formDisabled=!1,this.formElm={},this.isSignIn=!0}onInit(e,t,i){this.formElm=i.views.form}this$(e,t,r){if("routeParams"===e){if(-1===(r.appName||"").indexOf("sign-"))return;this.isSignIn="sign-in"===r.appName,this.errors=[],i.resetForm(this.formElm)}}submit(e,t,r){e.preventDefault(),this.formDisabled=!0,this.errors=[],i[this.routeParams.appName]({user:i.getFormData(t)}).then(e=>{this.formDisabled=!1,window.location.href=this.isSignIn?"#/articles/0/my-feed":"#/"}).catch(e=>{this.formDisabled=!1,this.errors=i.processErrors(e)})}})),
define("new-post.component",["circular","!new-post.component.html","api.service"],({Component:e},t,i)=>e({selector:"new-post",template:t,subscribe$:{this:["routeParams","formDisabled","title","description","body","tagList"]}},class{constructor(e,t,i,r){this.routeParams={},this.setUser=(()=>{}),i(this),this.formDisabled=!1,this.errors=[],this.model=[],this.formElm={},this.title="",this.description="",this.body="",this.tagList=""}onInit(e,t,i){this.formElm=i.views.form}this$(e,t,r){if("routeParams"===e){if(-1===(r.appName||"").indexOf("new"))return;this.errors=[],r.var0?i.article({article:r.var0}).then(e=>{this.setUser(e.user),this.title=e.article.title,this.description=e.article.description,this.body=e.article.body,this.tagList=e.article.tagList.join(", ")}):i.resetForm(this.formElm)}}submit(e,t,r){e.preventDefault(),this.formDisabled=!0,this.errors=[];const s=i.getFormData(t);s.tagList=s.tagList.split(/,*\s(?:\s*,\s*)*\s*/),i.postArticle({article:s,slug:this.routeParams.var0}).then(e=>{this.formDisabled=!1,window.location.href=`#/article/${e.article.slug}`}).catch(e=>{this.formDisabled=!1,this.errors=i.processErrors(e)})}})),
define("article-meta.component",["circular","!article-meta.component.html","template-helpers","api.service"],({Component:e},t,i,r)=>e({selector:"article-meta",template:t,styles:"article-meta img { overflow: hidden; }",helpers:i,subscribe$:{this:["metaData","trigger","routeParams","user"],model:["*","author.*"]}},class{constructor(e,t,i){this.metaData={},this.user={},this.routeParams={},i(this),this.articles={},this.trigger=!1,this.idx=-1,i(this),this.model=[],this.crInst=t,-1===this.idx&&t.installEvent(null,"meta-click",e=>{const t=this.model[0],i=e.detail.item,s=e.detail.type;t&&t!==i&&("follow"===s?r.postFollow({author:{username:t.author.username,following:t.author.following}}).then(e=>{i.author.following===t.author.following&&(t.author.following=!t.author.following),i.author.following=!i.author.following}):"like"===s&&r.postLike({slug:t.slug,favorited:t.favorited}).then(e=>{i.favorited===t.favorited&&(t.favorited=!t.favorited),i.favorited=!i.favorited}))})}this$(e,t,i){if("metaData"===e)this.model=[{isOwn:this.user&&this.user.username===t.metaData.author.username,slug:this.routeParams.var0,...t.model.getCleanModel(t.metaData)}];else if("trigger"===e){if(this.idx!=i)return;const e=this.articles[this.idx];this.model=[{isSingle:!0,isOwn:this.user&&e.author.username===this.user.username,author:{...e.author},favorited:e.favorited,favoritesCount:e.favoritesCount,createdAt:e.createdAt}]}}model$(e,t,i){"favorited"===e&&(t.favoritesCount+=i?1:-1)}follow(e,t,i){this.crInst.triggerEvent("meta-click",{item:i,type:"follow"})}like(e,t,i){this.crInst.triggerEvent("meta-click",{item:i,type:"like"})}likeSingle(e,t,i){this.user?r.postLike({slug:this.articles[this.idx].slug,favorited:i.favorited}).then(e=>{i.favorited=!i.favorited}):window.location.href="#/sign-up"}delete(e,t,i){r.deleteArticle({slug:this.routeParams.var0}).then(e=>window.location.href="#/")}})),
define("article-comment-list.component",["circular","!article-comment-list.component.html","template-helpers","api.service"],({Component:e},t,i,r)=>e({selector:"article-comment-list",template:t,helpers:i,styles:"",subscribe$:{this:["comments","articleSlug"],comments:["*","author.*"]}},class{constructor(e,t,i,r){this.comments=[],this.articleSlug="",i(this),this.rootApp=r()}delete(e,t,i){r.deleteComment({id:i.id,slug:this.articleSlug}).then(e=>{this.rootApp.triggerLoadData()})}})),
define("article-comment-form.component",["circular","!article-comment-form.component.html","template-helpers","api.service"],({Component:e},t,i,r)=>e({selector:"article-comment-form",template:t,helpers:i,subscribe$:{this:["articleSlug"]}},class{constructor(e,t,i,r){this.user={},this.articleSlug="",i(this),this.rootApp=r()}submit(e,t,i){e.preventDefault(),r.postComment({comment:{comment:r.getFormData(t)},slug:this.articleSlug}).then(e=>{r.resetForm(t),this.rootApp.triggerLoadData()})}})),
define("article-list.component",["circular","!article-list.component.html","template-helpers","global-partials","article-list-pagination.component","article-meta.component"],({Component:e,Toolbox:{lazy:t}},i,r,s)=>e({selector:"article-list",template:i,partials:s,helpers:r,styles:"\narticle-list .tag-list { float: right; max-width: 75%; }\narticle-list .article-preview { clear: both }",subscribe$:{this:["pagination","noItems","trigger","user"],articles:["*","author.*"]}},class{constructor(e,t,i){this.user={},this.articles=[],this.pagination=[],i(this),this.noItems=!0,this.trigger=!1}articles$$(e,i,r,s){t(()=>{this.trigger=i.index,this.noItems=!this.articles.length},i)}})),
define("article.component",["circular","!article.component.html","api.service","template-helpers","global-partials","article-meta.component","article-comment-list.component","article-comment-form.component"],({Component:e},t,i,r,s)=>e({selector:"article",template:t,partials:s,styles:"article .tag-list { text-align: right }",helpers:r,subscribe$:{this:["routeParams","articleSlug","article","comments","metaData","user"],article:["*"]}},class{constructor(e,t,i){this.routeParams={},this.setUser=(()=>{}),this.user={},i(this),this.articleSlug="",this.article=[],this.comments=[],this.metaData={}}onInit(){this.triggerLoadData()}triggerLoadData(){this.articleSlug=this.routeParams.var0}this$(e,t,r,s){if("routeParams"===e&&"article"===r.appName&&(this.articleSlug=r.var0),"article"===this.routeParams.appName&&"articleSlug"===e&&r){const e=this.user&&this.user.username?this.user:void 0;i.article({article:r,user:e}).then(e=>{e.article.isLoggedIn=e.loggedIn(),this.setUser(e.user),this.article=[e.article],this.comments=e.comments.map(t=>(t.isUser=e.user&&e.user.username===t.author.username,t)),this.metaData={author:{...e.article.author},favorited:e.article.favorited,favoritesCount:e.article.favoritesCount,createdAt:e.article.createdAt}})}}})),
define("home.component",["circular","!home.component.html","api.service","article-list.component","tag-list.component","feed-menu.component","banner.component"],({Component:e},t,i)=>e({selector:"home",template:t,subscribe$:{this:["routeParams","articles","tags","tag","pagination","isLoggedIn","user"]}},class{constructor(e,t,i,r,s){this.routeParams={},this.setUser=(()=>{}),this.user={},i(this),this.articles=[],this.tags=[],this.tag="",this.pagination=[],this.isLoggedIn=!1,this.type=s}getArticles(e,t,r=10,s,n=!1){return e=e>=0?e:0,this.tag=t,i.articles({limit:r,offset:e,tag:t,ownFeed:"my-feed"===t,author:s,root:this.type,favorited:n,user:this.user&&this.user.username?this.user:void 0}).then(e=>{this.isLoggedIn=e.loggedIn(),this.setUser(e.user),this.articles=e.articles,this.tags=e.tags.map(e=>({key:e})),this.pagination=e.pagination})}this$(e,t,i){i&&"articles"!==i.appName&&i.appName||"user"===e||"routeParams"!==e||this.type||this.getArticles(+i.var0-1,i.var1||"")}})),
define("profile.component",["circular","!profile.component.html","home.component","api.service"],({Component:e},t,i,r)=>e({selector:"profile",template:t,subscribe$:{this:i.subscribe$.this.concat("profileName"),profile:["*"]}},class extends i.Klass{constructor(e,t,i,r){super(e,t,i,r,"profile"),this.profile=[],this.profileName="",this.getProfile()}getProfile(e=0){if("profile"!==this.routeParams.appName)return;const t=this.routeParams.var0,i=(this.profile[0]||{}).username===t,s="favorites"===this.routeParams.var2;i||r.profile({author:t}).then(e=>{const t=e.profile.profile;this.profile=[{isUser:e.user&&t.username===e.user.username,...t,bio:t.bio||""}],this.profileName=t.username}),this.getArticles(e,"",5,t,s)}this$$(e,t,i){"routeParams"===e&&this.getProfile(+i.var1-1)}follow(e,t,i){r.postFollow({author:{username:i.username,following:i.following}}).then(e=>{i.following=!i.following})}})),
define("main-app.comp",["circular","schnauzer","global-partials","data.service","api.service","navbar.comp","home.component","new-post.component","settings.component","sign-in.component","profile.component"],({Module:e},t,i,r,s)=>e({selector:".main-app, main-app, [main-app]",subscribe$:{this:["activeLink","routeParams","user"]}},class{constructor(e,t){this.activeLink={},this.routeParams={},this.user={}}setUser(e){return this.user=e}onInit(e,t){t.addRoute({path:"(/:appName)(/:var0)(/:var1)(/:var2)(/*)",callback:({parameters:e})=>{const i=this.activeLink;this.activeLink=r.getLink(e.appName)||{},i.app!==this.activeLink.app?t.renderModule({require:this.activeLink.app,container:"app-outlet",input:"routeParams, setUser, user",this:this}).then(()=>{this.routeParams=e}):this.routeParams=e}},!0)}}));